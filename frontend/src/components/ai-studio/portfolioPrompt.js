...
- Before returning the JSON, compile-check every JSX element whose name starts with an uppercase letter, such as Hero, Header, or Projects. Each one must either be a locally declared component or variable in that file or a valid import. Never render an undefined component.
