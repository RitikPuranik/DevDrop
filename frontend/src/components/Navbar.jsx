...
const Navbar = () => {
  ...
  const [showAuthModal, setShowAuthModal] = useState(false); // State for the Pop-up
  ...
  const menuItems = [
    ...
    { to: "/website", label: "Make Your Own", src: "https://images.unsplash.com/photo-1703669020883-66f3e77ae929?q=80&w=435&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
  ...
  // Helper to open modal and close menu simultaneously
  const openLogin = () => {
    setIsOpen(false);
  ...
  return (
    <>
      {/* 1. THE AUTH MODAL (POPS UP ON TOP OF EVERYTHING) */}
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="mt-12 w-1/2 h-full flex flex-col justify-center text-center pb-12 px-24">
              ...
              {/* LOGIN TRIGGER: Now calls openLogin function instead of a Link */}
              <motion.div 
