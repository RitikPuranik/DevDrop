...
// import React, { useState, useEffect } from 'react';
// import { motion, AnimatePresence } from 'framer-motion';
// import { X, Play, ShoppingCart, Zap } from 'lucide-react';
...
//         setTemplates(res.data.websites || res.data);
...
//                 transition={transition}
//                 style={{ backgroundColor: item.color || "#1E1E1E" }}
//                 className="aspect-[12/11] rounded-[32px] mb-6 relative overflow-hidden flex items-center justify-center border border-white/5"
//               >
//                 <div className="w-26 h-24 bg-white/5 blur-3xl rounded-full" />
//               </motion.div>
...
//                 <motion.h3
//                   layoutId={`title-${item._id || item.id}`}
//                   transition={transition}
...
//                 <motion.p
//                   layoutId={`price-${item._id || item.id}`}
//                   transition={transition}
//                   className="text-[#8b7355] font-bold text-sm tracking-widest"
//                 >
//                   {item.price}
//                 </motion.p>
...
//                   transition={transition}
//                   style={{ backgroundColor: selectedId.color || "#1E1E1E" }}
//                   className="h-full min-h-[400px] rounded-[40px] relative flex items-center justify-center overflow-hidden border border-white/5"
//                 >
//                   <Play className="text-white/20" size={80} />
//                 </motion.div>
...
//                   <motion.h2
//                     layoutId={`title-${selectedId._id || selectedId.id}`}
//                     transition={transition}
...
//                   <motion.div
//                     layoutId={`price-${selectedId._id || selectedId.id}`}
//                     transition={transition}
//                     className="text-3xl font-light italic text-gray-500 mb-8"
//                   >
//                     {selectedId.price}
//                   </motion.div>
