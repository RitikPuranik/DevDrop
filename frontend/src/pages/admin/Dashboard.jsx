...
import { Loader2, ShieldCheck, Users, Globe, DollarSign, TrendingUp, ShoppingCart, ArrowUpRight, ArrowDownRight } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-[#080808] text-white flex items-center justify-center px-6">
        <div className="max-w-lg w-full rounded-[32px] border border-white/10 bg-white/[0.03] p-8 text-center backdrop-blur-2xl">
          ...
          <p className="text-white/40 text-sm leading-relaxed mb-8">Sign in with an admin account to view the dashboard.</p>
    ...
    <div className="min-h-screen bg-[#080808] text-white pt-24 md:pt-32 pb-16 px-4 md:px-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          {/* Revenue Breakdown */}
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="rounded-[32px] border border-white/10 bg-[#0f0f0f] p-6 md:p-8 shadow-2xl shadow-black/30">
          ...
          {/* Website Stats */}
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="rounded-[32px] border border-white/10 bg-[#0f0f0f] p-6 md:p-8 shadow-2xl shadow-black/30">
          ...
          {recentActivity.length === 0 ? (
            ...
            <div>
              {recentActivity.map((purchase, i) => (
                <ActivityRow key={purchase._id || i} purchase={purchase} />
              ))}
            </div>
          )}
        </motion.div>
