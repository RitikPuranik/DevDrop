  ...
  return <div className="min-h-screen bg-[#050505] pt-28 text-[#e8e2d6] sm:pt-36">
    ...
    <div className="mx-auto max-w-7xl px-[6vw] py-8 lg:grid lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-16">
      ...
      <article className="max-w-3xl">
        ...
        <DocSection id="support" title="Support"><p>Need help with a purchase, export, or deployment? Contact the DevDrop team with the project and deployment status details (never secrets or tokens).</p><a href="/contact" className="inline-flex items-center gap-2 rounded-xl bg-[#8b7355] px-5 py-3 text-xs font-bold uppercase tracking-widest text-white hover:bg-[#725e46] transition-colors">Contact support <ExternalLink size={14} /></a></DocSection>
      </article>
    </div>
  </div>;
}
